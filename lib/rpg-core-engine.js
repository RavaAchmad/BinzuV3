...
const GAME_CONFIG = {
  ...
  // Cooldowns (in milliseconds) - Optimized untuk group rental
  COOLDOWNS: {
    dungeon: 300000,        // 5 minutes (was 10)
    bosraid: 1800000,       // 30 minutes (was 60)
    hunt: 180000,           // 3 minutes (was 5) - Basic activity
    mining: 180000,         // 3 minutes (was 5) - Basic activity
    fishing: 180000,        // 3 minutes (was 5) - Basic activity
    work: 180000,           // 3 minutes (was 5) - Basic activity
    adventure: 300000,      // 5 minutes (was 10)
    mission: 86400000,      // 24 hours (no change)
    steal: 300000           // 5 minutes (was 10)
  }
}
